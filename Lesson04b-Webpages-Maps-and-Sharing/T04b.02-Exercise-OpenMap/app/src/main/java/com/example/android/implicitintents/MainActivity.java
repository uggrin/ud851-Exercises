...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        Log.i(TAG, "onClickOpenAddressButton: " + addressUri.toString());

        showMap(addressUri);
    }

    /**
     * This  is called when the Share Text Content button is clicked. It will simply share
